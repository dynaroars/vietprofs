...
- [ ] Batch 22 — `vp-0421`–`vp-0440`; 20 people; 19 complete outcomes; counts: 6 verified overviews, 13 no-suitable-evidence overviews, 5 verified work sections (4 selected, 1 recent), 14 no-suitable-evidence work searches; 1 retry in queue (`vp-0426`).
- [ ] Batch 23 — `vp-0441`–`vp-0460`; 20 people; pending.

Progress note: batches 1 through 22 processed (336 verified overviews, 72 no-suitable-evidence overviews, 226 verified work sections [63 selected, 163 recent], 182 no-suitable-evidence work results, 32 retries in queue). Batch 22 will be published now; Batch 23 will be processed next.

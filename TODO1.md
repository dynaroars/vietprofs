...
- [ ] Batch 29 — `vp-0561`–`vp-0580`; 20 people; 18 complete outcomes; counts: 14 verified overviews, 4 no-suitable-evidence overviews, 3 verified work sections (3 recent), 15 no-suitable-evidence work searches; 2 retries in queue (`vp-0561`, `vp-0578`).
- [ ] Batch 30 — `vp-0581`–`vp-0600`; 20 people; pending.

Progress note: batches 1 through 29 processed (405 verified overviews, 108 no-suitable-evidence overviews, 260 verified work sections [85 selected, 175 recent], 253 no-suitable-evidence work results, 67 retries in queue). Batch 29 will be published now; Batch 30 will be processed next.

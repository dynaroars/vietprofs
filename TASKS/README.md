...
| [`discover_academic_relationships.md`](discover_academic_relationships.md) | Verify roster-internal doctoral mentorship, documented postdoctoral mentorship, and coauthorship relationships; personal relationships are prohibited. | `public/relationships.json` direct-to-`main` commits |

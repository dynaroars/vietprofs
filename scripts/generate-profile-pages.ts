  ...
  <div id="app">
    <main>
      <article class="man-page">
        <p class="man-running-head"><span><a href="../">${sectionLabel}</a></span><span class="man-running-title"><a class="man-running-brand" href="../" aria-label="VietProfs directory"><img class="brand-logo" src="../vietprofs-bamboo-v.svg" alt="" width="20" height="20"><span class="man-running-label">VietProfs Profile Manual</span></a></span><span><a href="../">${sectionLabel}</a></span></p>
        ...
        <footer><p class="man-footer-line"><a href="../">${sectionLabel}</a> · ${escapeHtml(person.id)} · <a href="../">${sectionLabel}</a></p></footer>
      </article>
    </main>
    ${profileScript}
  </div>

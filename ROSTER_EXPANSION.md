...
| Chemical Engineering | Done (2026-08-18) | 4 entries added: Trung Van Nguyen (U Kansas, Chemical & Petroleum Engineering), Ngoc Bui (U Oklahoma, School of Sustainable Chemical, Biological and Materials Engineering), Jonathan T. Pham (U Cincinnati, Chemical Engineering), Thi Vo (Johns Hopkins, Chemical and Biomolecular Engineering). Rejected: Binh Vu (U Houston) — research-track; Hang Lu (Georgia Tech) — otherwise a strong match but Vietnamese heritage unconfirmed; Hung V.-T. Nguyen (Dartmouth Thayer) — no separate ChemE department, better fit for a future Bioengineering pass; Duong D. Do — U Queensland, Australia, not U.S.; Thomas Dinh Tran (U Cincinnati) — teaching-track "Educator" title; Kim-Vy Nguyen-Ngoc (UCSD) — Pediatrics, not ChemE; Mi (Kelly) Hoang Tran (RPI) — business school entrepreneurship, not engineering; Khanh Nguyen (Texas A&M) — CS, already in roster; Annalee Nguyen (UT Austin) — research-track; Nam-Trung Nguyen — Griffith University, Australia; Tuan Vo-Dinh/Hien M. Nguyen/SonBinh T. Nguyen/Thuc-Quyen Nguyen — already in roster under Chemistry. Broad directory scans with no matches at Auburn, Texas Tech, Purdue, Oregon State, South Carolina, Georgia Tech ChBE, USF, Northwestern ChBE, TAMU. Added `FIELD_RULES` entry for Chemical Engineering in `src/data.js`. |

...
test('connection keyword search finds connected roster members by relationship type', () => {
  ...
  assert.deepEqual(
    ...
    new Set([
      ...
      'vp-0267', 'vp-0275', 'vp-0711', 'vp-1674',
    ]),
  );
  ...
  assert.deepEqual(
    ...
    new Set(['vp-0015', 'vp-0018', 'vp-0032', 'vp-0056', 'vp-0063', 'vp-0275']),
  );
  ...
  assert.deepEqual(
    ...
    new Set([
      ...
      'vp-0100', 'vp-0123', 'vp-0183', 'vp-0184', 'vp-0193', 'vp-0267', 'vp-0275', 'vp-0711', 'vp-1674',
    ]),
  );
});
